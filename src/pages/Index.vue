<template>
  <Layout>
    ...
    <p>I'm a software developer with a love for interactive technology.</p>
    <p>I've been doing a lot of <g-link to="/writing/expanding-types-unobtrusively">Typescript</g-link> this 
      ...
      I've made a couple websites using it like this portfolio and <g-link to="/projects/cilantro">a local resturant's 
